...
function addIcon (ic,sv,src,h) {
  ...
  let shape = document.importNode(src.querySelector(`#${ic}`),true),
    ...
    xSca = val.hexSize.x/75, ySca = val.hexSize.y/75,
    xOff = hC.x - (50*xSca), yOff = hC.y - (50*ySca);
...
function getForm(){
  ...
  this.theta =
    parseFloat(document.getElementById("orientation").value,10) * Math.PI/12;
  this.hexSize = {
